package it.uniroma3.siw.cateringService.authentication;
import static it.uniroma3.siw.cateringService.model.Credentials.ADMIN_ROLE;
...
public class AuthConfiguration extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.GET, "/", "/index", "/login", "/register", "/adminRegister", "/css/**", "/images/**").permitAll()
